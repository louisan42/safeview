...
async def list_incidents(
    ...
    limit: int = Query(
        ...
        ge=1,
        le=5000,
        description="Page size. Default 500; maximum 5000. Map clients should pass bbox and request up to 5000 so a typical city window is not truncated at 500.",
        examples={"sample": {"value": 100}},
    ),
